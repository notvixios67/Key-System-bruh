...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/notvixios67/Key-System-bruh/refs/heads/main/scripts.lua", -- The raw URL of your main script
    ...
    HubName         = "Vix GUI", -- The main title shown at the top of the GUI
    HubDescription  = "idk" -- The text shown below the title
}
...
local function CreateGUI()
    ...
    if Config.ShowYoutube then
        ...
        YTIcon.Position = UDim2.new(0.1, 0, 0.5,
